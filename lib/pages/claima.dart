...
Future<List<ClaimaData>> fetchClaimaData() async {
  ...
  if (response.statusCode == 200) {
    ...
    List<ClaimaData> claimalist = await resultsJson
        .map<ClaimaData>((json) => ClaimaData.fromJson(json))
        .toList();
    return claimalist;
    ...
    throw Exception('Failed to load ClaimaData');
  }
}
...
class ClaimaData {
  ...
  factory ClaimaData.fromJson(Map<String, dynamic> json) {
    return ClaimaData(
      titre: json['titre'],
      cin: json['cin'],
...
class Claima extends StatefulWidget {
  const Claima({Key? key}) : super(key: key);
  @override
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
        ...
        Expanded(
            child: FutureBuilder<List<ClaimaData>>(
                future: fetchClaimaData(),
