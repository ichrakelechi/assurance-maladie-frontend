...
Future<List<DoctorData>> fetchDoctorData() async {
  ...
  if (response.statusCode == 200) {
    ...
    List<DoctorData> doctoralist = await resultsJson
        .map<DoctorData>((json) => DoctorData.fromJson(json))
        .toList();
    return doctoralist;
    ...
    throw Exception('Failed to load DoctorData');
  }
}
...
class Doctora extends StatefulWidget {
  const Doctora({Key? key}) : super(key: key);
  @override
  State<Doctora> createState() => _DoctoraState();
}
