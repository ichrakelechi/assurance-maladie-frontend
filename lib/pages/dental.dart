...
class Dental extends StatelessWidget {
  ...
  Dental({required this.idbulletin});
  ...
  Widget build(BuildContext context) {
    ...
    print(_id_Bulletin);
    addDental(
        type, date, tooth, coefficient, fees, montant, id_bulletin) async {
      String url = "http://localhost:2550/dental";
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Text("soins dentaires et prothése",
                          style: TextStyle(
