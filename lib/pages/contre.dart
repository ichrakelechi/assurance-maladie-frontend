...
Future<List<ContreData>> fetchContreData() async {
  ...
  if (response.statusCode == 200) {
    ...
    List<ContreData> Contrelist = await resultsJson
        .map<ContreData>((json) => ContreData.fromJson(json))
        .toList();
    return Contrelist;
...
class ContreData {
  ...
  factory ContreData.fromJson(Map<String, dynamic> json) {
    return ContreData(
      titre: json['titre'],
      cin: json['cin'],
...
class Contre extends StatefulWidget {
  const Contre({Key? key}) : super(key: key);
  @override
  State<Contre> createState() => _ContreState();
}

class _ContreState extends State<Contre> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          children: [
            Padding(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Addcontre()));
                },
        ...
        Expanded(
            child: FutureBuilder<List<ContreData>>(
                future: fetchContreData(),
